////////////////////////////////////////////////////////////////////////////////
// FILE: config_FIXED.h
// DESC: Hardware configuration, fuses, and pin mapping - FIXED version
// DEVICE: PIC18F2685
// FREQ: 20MHz Crystal (HS mode)
//
// CHANGES FROM ORIGINAL:
// - CHATTER_N: 3 -> 2 (faster sensor response, 2ms debounce instead of 3ms)
//
////////////////////////////////////////////////////////////////////////////////
...
// SENSOR CONSTANTS
// ============================================================================
// FIXED: Reduced from 3 to 2 for faster sensor response
// Original: 3ms debounce (3 samples @ 1ms)
// Fixed: 2ms debounce (2 samples @ 1ms) - faster response at junctions
#define CHATTER_N        2
