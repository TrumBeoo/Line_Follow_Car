...
#define SENSOR_LEFT      PIN_A0    // Left IR sensor (Active LOW)
#define SENSOR_MID       PIN_A1    // Middle IR sensor (Active LOW)
#define SENSOR_RIGHT     PIN_A2    // Right IR sensor (Active LOW)
...
// --- PERIPHERALS ---
#define LED_STATUS       PIN_B2    //B2 LED1 - Status LED (run indicator)
#define LED_ACTION       PIN_B3    //B3 LED2 - Action LED (ball grab/release)
...
// --- Sensor Filter ---
#define CHATTER_N        3         // Number of consecutive samples for filter
...
// --- Timing Constants (ms) ---
#define GRAB_MS          2000      // Ball grab duration
#define RELEASE_MS       2000      // Ball release duration
...
// ============================================================================
// SENSOR PATTERN DEFINITIONS (for lookup table)
// ============================================================================
